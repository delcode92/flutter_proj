...
Future<void> main() async {
  final client =
      // MqttServerClient.withPort('mqtt.eclipseprojects.io', '#', 1883);
      MqttBrowserClient.withPort('ws://mqtt.eclipseprojects.io/mqtt', '#', 80);
  ...
  try {
    ...
    print('==> something not right::client exception - $e');
    client.disconnect();
  }
